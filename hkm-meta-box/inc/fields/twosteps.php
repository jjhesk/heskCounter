...
if (!class_exists('RWMB_Twosteps_Field')) {
	class RWMB_Twosteps_Field {
		...
		static function html($html, $meta, $field) {
			...
			if(!isset($options['step_2'])||!isset($options['step_1']))return $html;
			$html = '';
		...
		static function step_two_advanced(&$list1, &$list2, $fields, $data) {
			...
			//	$field['options']
			$label_placeholder_1=$fields['options']['step_1_placeholder'];
			$label_placeholder_1=isset($label_placeholder_1)?$label_placeholder_1:'pick one';
			$label_placeholder_2=$fields['options']['step_2_placeholder'];
			$label_placeholder_2=isset($label_placeholder_2)?$label_placeholder_2:'pick one';
			$setting_options_array = array('step1' => $label_placeholder_1, 'step2' => $label_placeholder_2, );
			$step2_list = array();
			$field_hide = '';
